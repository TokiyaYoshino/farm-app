// src/data/maffIpm.ts の検証（作物 → 公的資料の引き当て）。
//
//   cd ~/Projects/farm-app && node scripts/test-maff-ipm.mjs
//
...
// src/data/maffIpm.ts は "../lib/cropAlias"（拡張子なし）を import する。
...
const { referencesForCrop, manualCrops } =
  await import(pathToFileURL(process.cwd() + "/src/data/maffIpm.ts").href);
