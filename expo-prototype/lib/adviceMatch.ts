 ...
 */
export function matchAction(a: AdviceAction, reports: Report[], today: string): ActionMatch {
...
export function matchActions(actions: AdviceAction[], reports: Report[], today?: string): ActionMatch[] {
