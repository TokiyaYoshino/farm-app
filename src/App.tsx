...
export default function App() {
  ...
  const cropName = (id: number) => CROPS.find(c => c.id === id)?.name || "不明";
  ...
  const S = {
    ...
    page:    css({ padding:16 }),
    card:    css({ background:"#fff", borderRadius:12, padding:16, marginBottom:12, boxShadow:"0 1px 4px rgba(0,0,0,0.08)" }),
    sec:     css({ fontSize:14, fontWeight:"bold", color:"#555", marginBottom:10, marginTop:4 }),
    lbl:     css({ fontSize:12, color:"#888", marginBottom:4 }),
    input:   css({ width:"100%", padding:"10px 12px", borderRadius:8, border:"1px solid #ddd", fontSize:15, boxSizing:"border-box", marginBottom:10 }),
    select:  css({ width:"100%", padding:"10px 12px", borderRadius:8, border:"1px solid #ddd", fontSize:15, boxSizing:"border-box", marginBottom:10, background:"#fff" }),
    btn:     css({ background:"#2d6a2d", color:"#fff", border:"none", borderRadius:8, padding:"12px 0", width:"100%", fontSize:15, fontWeight:"bold", cursor:"pointer" }),
    btnSm:   css({ background:"#e74c3c", color:"#fff", border:"none", borderRadius:6, padding:"5px 10px", fontSize:12, cursor:"pointer" }),
    row:     css({ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:6 }),
    wxBox:   css({ background:"linear-gradient(135deg,#e8f5e9,#c8e6c9)", borderRadius:12, padding:"12px 16px", marginBottom:12 }),
    wxBadge: css({ background:"#fff", borderRadius:8, padding:"8px 12px", display:"inline-flex", alignItems:"center", gap:6, fontSize:14, fontWeight:"bold", color:"#333", marginRight:8 }),
